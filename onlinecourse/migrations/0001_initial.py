# Generated by Django 3.1.3 on 2022-07-23 09:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choice_text', models.CharField(default='enter your choice here', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('selected_choices', models.ManyToManyField(to='onlinecourse.Choice')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question_title', models.CharField(default='title', max_length=200)),
                ('questiongrade', models.IntegerField(default=1)),
                ('questiontext', models.CharField(default='Enter Question', max_length=200)),
                ('Course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='onlinecourse.course')),
            ],
        ),
        migrations.CreateModel(
